...
function Heading(_a) {
    var tag = _a.tag, className = _a.className, size = _a.size, onContrast = _a.onContrast, css = _a.css, children = _a.children, props = __rest$1(_a, ["tag", "className", "size", "onContrast", "css", "children"]);
    return (React.createElement(Wrapper$1, __assign$1({ css: css, as: tag, size: size, onContrast: onContrast }, props, { className: className }), children));
}
...
}function MdOutlineRemove (props) {
...
}function MdOutlineExpandMore (props) {
...
var icons = {
    ...
    chevronDown: MdOutlineExpandMore,
    ...
    alert: IoMdAlert,
    menu: IoIosMenu,
    qrCodeBorder: MdQrCodeScanner,
    clip: BsPaperclip,
    share: RiShareFill,
    edit: FaEdit,
    eyes: AiOutlineEye,
    eyesSlash: BsEyeSlash,
    user: FaRegUser,
    qrcode: MdQrCode2,
...
function IconComponent(_a) {
    var name = _a.name, props = __rest$1(_a, ["name"]);
    var IconFromName = icons[name];
    return React.createElement(IconFromName, __assign$1({}, props));
}
...
function Button(_a) {
    var _b = _a.disabled, disabled = _b === void 0 ? false : _b, _c = _a.tag, tag = _c === void 0 ? 'button' : _c, _d = _a.onContrast, onContrast = _d === void 0 ? false : _d, _e = _a.border, border = _e === void 0 ? false : _e, text = _a.text, href = _a.href, target = _a.target, _f = _a.type, type = _f === void 0 ? 'button' : _f, css = _a.css, onClick = _a.onClick, icon = _a.icon, _g = _a.link, link = _g === void 0 ? false : _g, _h = _a.iconSize, iconSize = _h === void 0 ? 21 : _h, _j = _a.iconEnd, iconEnd = _j === void 0 ? false : _j, props = __rest$1(_a, ["disabled", "tag", "onContrast", "border", "text", "href", "target", "type", "css", "onClick", "icon", "link", "iconSize", "iconEnd"]);
    return (React.createElement("div", null, href ? (React.createElement("a", __assign$1({ href: href }, props),
        React.createElement(Wrapper, { as: tag, css: css, onContrast: onContrast, border: border, target: target, onClick: onClick },
            icon && !iconEnd && (React.createElement(IconComponent, { name: icon, size: iconSize, className: "icon-start" })),
            React.createElement(Text, { css: {
                    fontWeight: link ? '$normal' : '$bold',
                    // textTransform: link ? 'none' : 'uppercase',
                } }, text),
            icon && iconEnd && (React.createElement(IconComponent, { name: icon, size: iconSize, className: "icon-end" }))))) : (React.createElement(Wrapper, __assign$1({ as: tag, css: css, onContrast: onContrast, border: border, type: type, onClick: onClick, disabled: disabled, disabledStyled: disabled }, props),
        icon && !iconEnd && (React.createElement(IconComponent, { name: icon, size: iconSize, className: "icon-start" })),
        React.createElement(Text, null, text),
        icon && iconEnd && (React.createElement(IconComponent, { name: icon, size: iconSize, className: "icon-end" }))))));
}
